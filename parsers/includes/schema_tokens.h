...
#line 172 "/work/dev/wookler/ReactFS/parsers/includes/schema_tokens.h" // lalr1.cc:377
    ...
    schema_parser (schema_scanner  &scanner_yyarg, schema_driver  &driver_yyarg);
    virtual ~schema_parser ();
  ...
  private:
    ...
    schema_parser (const schema_parser&);
    schema_parser& operator= (const schema_parser&);
