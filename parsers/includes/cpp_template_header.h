...
namespace parsers {		
					...
					private:
						...
						void __init() {
							...
							values->push_back("std::unordered_map<${key_type}, ${value_type} *> *deserialize_map_${name}(void *__input) {");
							...
							values->push_back("	");
							values->push_back("	std::unordered_map<${key_type}, ${value_type} *> __map = new std::unordered_map<${key_type}, ${value_type} *>();");
							...
							values->push_back("std::unordered_map<${key_type}, __struct_datatype__ *> *serialize_map_${name}(std::unordered_map<${key_type}, ${value_type} *> *__i_map) {");
							...
							values->push_back("std::vector<${type} *> *deserialize_list_${name}(void *__input) {");
							values->push_back("	CHECK_NOT_NULL(__input);");
							...
							values->push_back("std::vector<__struct_datatype__ *> *serialize_list_${name}(std::vector<${type} *> *__value) {");
							...
							values->push_back("void *serialize_${name}(${type} *__value) {");
							...
							values->push_back("${type} *deserialize_${name}(void *__input) {");
							values->push_back("    CHECK_NOT_NULL(__input);");
