 ...
 *  Generated by : subho
 *  Generated on : 2016-12-27 13:12:55.843
 */
    ...
    namespace wookler {
        namespace test {
            ...
            private:
                ...
                void set_value_r_map(__struct_datatype__ *__data) {
                    if (NOT_NULL(__data)) {
                        __struct_datatype__::const_iterator iter = __data->find("r_map");
                        if (iter != __data->end()) {
                            void *__ptr = iter->second;
                            if (NOT_NULL(__ptr)) {
                                std::unordered_map<char, test_type *> *__var = deserialize_map_unordered_map_std__string__test_type___(
                                        __ptr);
                ...
                void set_map_r_map(__struct_datatype__ *__data) {
                    CHECK_NOT_NULL(__data);
                    if (NOT_NULL(this->r_map)) {
                        void *__ptr = serialize_map_unordered_map_std__string__test_type___(this->r_map);
                        CHECK_NOT_NULL(__ptr);
                        __data->insert({"r_map", __ptr});
